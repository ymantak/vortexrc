...
--------------------------------------------------------------*/
  ...
  /*--------------------------------------------------------------
    19. Theme Mode Switcher (Dark/Light Mode)
--------------------------------------------------------------*/

  if ($.exists(".mode-switcher")) {
    ...
    function setTheme(mode) {
      ...
      $body.toggleClass("light-mode", selectedMode === "light");

      $buttons.each(function () {
        const $button = $(this);
        const isActive = $button.data("mode") === selectedMode;
    ...
    $(document).on("click", ".js-mode-type button", function () {
